          ...
          <div className="max-w-[330px] w-full">
            ...
            <ul className="flex flex-col gap-3">
              <li className="flex gap-4.5">
                ...
                Del Marie Gardens, Avonlea, Harare.
              </li>
                ...
                <a href="#" className="flex items-center gap-4.5">
                  ...
                  >
                    <defs>
                      ...
                      >
                        <stop offset="0" stop-color="#2556ab"></stop>
            ...
            <div className="flex items-center gap-4 mt-7.5">
              <a
                href="https://facebook.com/ericksonplaza"
              ...
              <a
                href="https://x.com/ericksonplaza"
              ...
              <a
                href="#"
                aria-label="https://instagram.com/ericksonplaza"
                className="flex ease-out duration-200 hover:text-blue"
              >
                <svg
                  className="fill-current"
              ...
              <a
                href="https://linkedin.com/in/ericksonplaza"
        ...
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-5 flex-wrap items-center justify-between">
            <p className="text-dark font-medium">
              &copy; {year}. All rights reserved by EricksonPlaza.
            </p>

            <div className="flex flex-wrap items-center gap-4">
              <p className="font-medium">We Accept cash on delivery or :</p>
